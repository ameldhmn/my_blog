...
Pour obtenir les prévisions météorologiques à 7 jours pour le Stade de France, nous pouvons utiliser la fonction `get_forecast()` en spécifiant "Stade de France" comme adresse :
...
Pour obtenir les prévisions météorologiques pour Tahiti, nous utilisons la fonction **`get_forecast()`** en spécifiant "Tahiti" comme adresse :
...
Pour obtenir les prévisions météorologiques pour les coordonnées GPS 43.276703, 5.334791, nous pouvons utiliser la fonction **`get_forecast`**:
